      ...
      <div className="container mx-auto flex h-20 items-center justify-between px-4 md:px-6">
        ...
        <nav className="hidden items-center gap-8 md:flex">
          ...
          <div className="group relative h-full flex items-center">
            <span className="cursor-default text-sm font-medium text-stone-400 transition-colors group-hover:text-white py-4">
              Products
            </span>
            <div className="absolute left-1/2 top-full w-48 -translate-x-1/2 pt-2 opacity-0 invisible translate-y-2 transition-all duration-200 group-hover:opacity-100 group-hover:visible group-hover:translate-y-0">
              <div className="flex flex-col overflow-hidden rounded-xl border border-stone-800/50 bg-black/90 backdrop-blur-xl p-2 shadow-xl">
                <Link
