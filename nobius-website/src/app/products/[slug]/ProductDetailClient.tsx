                    ...
                    <div className="flex flex-col gap-12 lg:flex-row lg:items-center">
                        ...
                        <div className="flex-1 space-y-8">
                            <div>
                                ...
                                <h1 className="font-serif text-4xl font-bold tracking-tight text-stone-100 md:text-5xl lg:text-6xl">
                                    {product.name}
                                </h1>
                                <p className="mt-2 text-xl font-medium italic text-stone-400">
                                    {product.tagline}
                                </p>
                            </div>
                            ...
                            <div className="flex flex-col gap-4 sm:flex-row">
                                <button
                                    ...
                                    className="inline-flex h-12 items-center justify-center rounded-full bg-stone-100 px-8 text-sm font-medium text-stone-900 transition-colors hover:bg-stone-200"
                                >
                                    Contact us to Order
                                </button>
                            </div>
